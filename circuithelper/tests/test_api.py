...
class TestCircuitCostAPI:
    ...
    def test_list_circuit_costs(self, authenticated_api_client, circuit):
        ...
        CircuitCost.objects.create(
            circuit=circuit, nrc=Decimal("500.00"), mrc=Decimal("150.00"), currency="USD"
        )

        response = authenticated_api_client.get("/api/plugins/circuit-manager/circuit-costs/")
    ...
    def test_create_circuit_cost(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.post(
            "/api/plugins/circuit-manager/circuit-costs/", data, format="json"
        )
    ...
    def test_update_circuit_cost(self, authenticated_api_client, circuit):
        ...
        data = {"circuit": circuit.pk, "mrc": "200.00", "currency": "USD"}

        response = authenticated_api_client.patch(
            f"/api/plugins/circuit-manager/circuit-costs/{cost.pk}/", data, format="json"
        )
    ...
    def test_unauthenticated_access_denied(self, api_client):
        ...
        response = api_client.get("/api/plugins/circuit-manager/circuit-costs/")
...
class TestCircuitContractAPI:
    ...
    def test_list_circuit_contracts(self, authenticated_api_client, circuit):
        ...
        CircuitContract.objects.create(
            circuit=circuit, contract_number="CONTRACT-001", start_date=date(2024, 1, 1)
        )

        response = authenticated_api_client.get("/api/plugins/circuit-manager/circuit-contracts/")
    ...
    def test_create_circuit_contract(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.post(
            "/api/plugins/circuit-manager/circuit-contracts/", data, format="json"
        )
    ...
    def test_filter_contracts_by_circuit(
        self, authenticated_api_client, circuit, provider, circuit_type
    ):
        """Test filtering contracts by circuit."""
        circuit2 = Circuit.objects.create(
            cid="TEST-002", provider=provider, type=circuit_type, status="active"
        )
        ...
        CircuitContract.objects.create(
            circuit=circuit2, contract_number="CONTRACT-002", start_date=date(2024, 1, 1)
        )
...
class TestCircuitTicketAPI:
    ...
    def test_list_circuit_tickets(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.get("/api/plugins/circuit-manager/circuit-tickets/")
    ...
    def test_create_circuit_ticket(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.post(
            "/api/plugins/circuit-manager/circuit-tickets/", data, format="json"
        )
    ...
    def test_update_ticket_status(self, authenticated_api_client, circuit):
        ...
        data = {"status": "resolved", "resolution": "Issue was fixed by restarting equipment"}

        response = authenticated_api_client.patch(
            f"/api/plugins/circuit-manager/circuit-tickets/{ticket.pk}/", data, format="json"
        )
...
class TestCircuitPathAPI:
    ...
    def test_list_circuit_paths(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.get("/api/plugins/circuit-manager/circuit-paths/")
    ...
    def test_create_circuit_path(self, authenticated_api_client, circuit):
        ...
        response = authenticated_api_client.post(
            "/api/plugins/circuit-manager/circuit-paths/", data, format="json"
        )
...
class TestProviderAPIConfigAPI:
    ...
    def test_create_provider_api_config(self, authenticated_api_client, provider):
        ...
        response = authenticated_api_client.post(
            "/api/plugins/circuit-manager/provider-api-configs/", data, format="json"
        )
