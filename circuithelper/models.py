...
class CircuitCost(NetBoxModel):
    ...
    billing_account = models.CharField(
        max_length=100,
        blank=True,
        help_text='Provider billing account number'
    )
    last_updated_date = models.DateField(
        null=True,
        blank=True,
        help_text='Date when cost information was last updated'
    )
...
class CircuitContract(NetBoxModel):
    ...
    contract_number = models.CharField(
        max_length=100,
        help_text='Contract or agreement number'
    )
    ...
    auto_renew = models.BooleanField(
        default=False,
        help_text='Does the contract auto-renew?'
    )
    ...
    notes = models.TextField(
        blank=True,
        help_text='Additional contract notes'
    )
...
class CircuitTicket(NetBoxModel):
    ...
    ticket_number = models.CharField(
        max_length=100,
        unique=True,
        help_text='Provider ticket number'
    )
    subject = models.CharField(
        max_length=255,
        help_text='Ticket subject or title'
    )
    ...
    opened_date = models.DateTimeField(
        auto_now_add=True,
        help_text='Date ticket was opened'
    )
    closed_date = models.DateTimeField(
        null=True,
        blank=True,
        help_text='Date ticket was closed'
    )
    ...
    external_url = models.URLField(
        blank=True,
        help_text='Link to external ticketing system'
    )
...
class CircuitPath(NetBoxModel):
    ...
    geojson_data = models.JSONField(
        null=True,
        blank=True,
        help_text='Parsed GeoJSON data from KMZ'
    )
    ...
    map_center_lon = models.DecimalField(
        ...
        null=True,
        blank=True,
        help_text='Map center longitude'
    )
    ...
    path_notes = models.TextField(
        blank=True,
        help_text='Notes about the circuit path'
    )
...
class ProviderAPIConfig(NetBoxModel):
    ...
    api_secret = models.CharField(
        max_length=255,
        blank=True,
        help_text='API secret (stored encrypted)'
    )
    ...
    sync_status = models.CharField(
        max_length=100,
        blank=True,
        help_text='Last sync status message'
    )
